...
def main():
    ...
    parser.add_argument("--rag-min-score", type=float, default=0.30)
    ...
    if args.output:
        ...
        output_path = output_dir / f"pseudo_topics_rag_v3_embedding_{safe_model_name}_{len(df)}.csv"
    ...
    print(f"RAG 최소 유사도: {args.rag_min_score}")
    ...
    with output_path.open("w", newline="", encoding="utf-8") as f:
        ...
        for i, row in df.iterrows():
            ...
            examples = retriever.retrieve(
                ...
                exclude_recommendationid=row.get("recommendationid"),
            ...
            output_row = {
                ...
                "prompt_version": "pseudo_topics_rag_v3_embedding",
                "rag_k": args.rag_k,
